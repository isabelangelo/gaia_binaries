...
# set data variables corresponding to dataset of interest
df_to_plot = test_set
flux_data_to_plot = flux_data
flux_err_data_to_plot = flux_err_data
...
for source_id in df_to_plot.source_id.to_numpy()[:3000]:
    ...
    flux = flux_data_to_plot[str(source_id)].to_numpy()[20:-20]
    ivar = 1/flux_err_data_to_plot[str(source_id)].to_numpy()[20:-20]**2
...
plt.savefig('/Users/isabelangelo/Desktop/cannon_galah_labels_test.png')