...
fits.HDUList([fits.PrimaryHDU(training_set_flux)]).writeto('./data_files/training_set_flux.fits')
fits.HDUList([fits.PrimaryHDU(training_set_sigma)]).writeto('./data_files/training_set_sigma.fits')
...
fits.HDUList([fits.PrimaryHDU(test_set_flux)]).writeto('./data_files/test_set_flux.fits')
fits.HDUList([fits.PrimaryHDU(test_set_sigma)]).writeto('./data_files/test_set_sigma.fits')
