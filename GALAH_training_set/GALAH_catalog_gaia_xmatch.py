...
GALAH_xmatch['designation'] = ['Gaia DR3 '+str(i)[12:-1] for i in GALAH_xmatch['designation']]
...
# save to file
GALAH_stars_filename = 'GALAH_star_catalog.csv'
...
GALAH_binaries_filename = 'GALAH_binary_catalog.csv'
